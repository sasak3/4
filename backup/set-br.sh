...
echo "Checking VPS"
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/sasak3/4/main/backup"
...
cd /usr/bin
wget -O autobackup "https://raw.githubusercontent.com/sasak3/4/main/backup/autobackup.sh"
...
wget -O limitspeed "https://raw.githubusercontent.com/sasak3/4/main/backup/limitspeed.sh"
chmod +x autobackup
chmod +x backup
chmod +x restore
chmod +x strt
