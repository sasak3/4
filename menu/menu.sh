...
echo -e "${Kcyan}════════════════════════════════════════════════════════════${NC}"
echo -e "${BGBLUE}                 SCRIPT VPS BY SETANVPN                      ${NC}"
echo -e "${Kcyan}════════════════════════════════════════════════════════════${NC}"
echo -e "${Kcyan}┌───────────────────────────────────────────┐${NC}"
...
echo -e "${Kcyan} ${NC}${Kbiru} •5${NC}${white} TROJAN-WS${NC}  "      "${Kbiru}10${NC}${white} MENU SETINGS${NC} " 
echo -e "${Kcyan}════════════════════════════════════════════════════════════${NC}"
echo -e "${BGBLUE}               Join Group http://t.me/TazVPN                          ${NC}"
echo -e "${Kcyan}════════════════════════════════════════════════════════════${NC}"  
echo -e ""
echo -e   "${kuning}"
read -p " >>>>  "  opt
